    ...
    public function home(){  
        ...
        for($x=0;$x<=23;$x++){
          ...
          if(!empty($unit)){
                ...
                //echo "capacity", "rtd_hour = '$next' AND rtd_date = '$date1' AND capacity !='0' ".$un_other."<br>";
                ...
                for($a=1;$a<=5;$a++){
                    ...
                    $ac[] = $this->super_model->select_ave_where("rtd_other", "actual_load", "rtd_hour = '$next' AND rtd_date = '$date1' AND actual_load !='0' AND unit='$ut'");
